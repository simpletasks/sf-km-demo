...
public class FileNameValidator {
	 ...
	 * @return instance of {@link File} if path is valid and file exist or <b>NULL</b> if path is not valid or file do not exist
	 */
	public static File checkIfFileExist(String fileName){
		...
		if (fileName.startsWith("/")){
			...
			String absolutePathToFile = String.join("/", currentDir, fileName);
